...
public class Generator : MonoBehaviour
{
    ...
    [SerializeField]
    private float _entitiesScaleMultiplier = .5f;
    [SerializeField]
    ...
    private void SpawnPlayer()
    {
        ...
        { 
            ...
            player.transform.localScale *= _entitiesScaleMultiplier;
        }
    }
    ...
    private void SpawnEntities()
    {
        if(bosses.Count > 0)
        {
            ...
            boss.transform.localScale *= _entitiesScaleMultiplier;
                    ...
                    for (int a = 0; a < enem; a++)
                    {
                        ...
                        do
                        {
                            ...
                            if(tempChild.CompareTag("Floor") && !parentRooms[i].MidPoints.Contains(tempChild) && !parentRooms[i].Corners.Contains(tempChild))
                            {
                                ...
                                tempEnemy.transform.localScale *= _entitiesScaleMultiplier;
